...
NATURE_DQN_OBSERVATION_SHAPE = (96, 96)  # Size of downscaled Atari 2600 frame.
NATURE_DQN_DTYPE = tf.uint8  # DType of Atari 2600 observations.
NATURE_DQN_STACK_SIZE = 3  # Number of frames in the state stack.
...
@gin.configurable
def create_carracing_environment(game_name=None, sticky_actions=True):
  ...
  env = GrayScaleObservation(gym.make(full_game_name,continuous = False))
...
class AtariPreprocessing(object):
  ...
  def __init__(self, environment, frame_skip=3, terminal_on_life_loss=False,
               screen_size=96):
